...
//                 <span className="text-gray-600">📞 {employee.call}</span>
//               </div>
//             </div>
//           </a>
//         ))}
...
//           className="cursor-pointer flex justify-center items-center bg-gray-100 hover:bg-gray-200 p-4 rounded-lg transition duration-300 ease-in-out"
//         >

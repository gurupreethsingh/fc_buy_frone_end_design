...
export default function TopBanner() {
  ...
  // Show the banner only if it's visible
  if (!isBannerVisible) {
    return null;
  }
    ...
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden  px-6  sm:px-3.5 sm:before:flex-1">
      ...
      >
        <div
          ...
          className="aspect-[577/310] w-[36.0625rem] bg-gradient-to-r from-[#ff80b5] to-[#9089fc] opacity-30 border-0"
        />
      </div>
      <div
        aria-hidden="true"
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        <p className="text-sm leading-6 text-gray-900">
          <strong className="font-semibold">FcBuy 2024</strong>
          <svg
            viewBox="0 0 2 2"
            aria-hidden="true"
